...
const ICON_PATHS: Record<IconName, string> = {
  ...
  blocks: '<path d="M10 22V7l10-3v15"/><path d="M10 7 2 4v15c0 1.1.9 2 2 2h6"/><path d="M20 4c1.1 0 2 .9 2 2v11c0 1.1-.9 2-2 2h-6"/>',
  'git-branch': '<line x1="6" x2="6" y1="3" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>',
  eye: '<path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/>',
  container:
    '<path d="M22 17.5a1.5 1.5 0 0 1-1.5 1.5H3.5A1.5 1.5 0 0 1 2 17.5V9.621a1.5 1.5 0 0 1 .853-1.352l7.5-3.5a1.5 1.5 0 0 1 1.294 0l7.5 3.5A1.5 1.5 0 0 1 22 9.621z"/><path d="M10 22V11.5"/><path d="M14 22V11.5"/>',
  'book-open':
...
export function getIconDataUrl(name: IconName, color = '#374151', strokeWidth = 2): string {
